...
本稿では、ユニセックス・ファッションにおける二つの記号戦略を区別する。第一は Expressive（Code-Switching）であり、ドレス、レース、ヒール、軍服的構造、テーラリングなど、男性的または女性的と読まれやすい服飾記号を、それまでとは異なる着用者、役割、場面へ移す実践である。第二は Neutralizing（Code-Diffusing）であり、性別記号を希釈し、着用者が過度に男性または女性として読まれない余地を作る実践である。両者は対立するものではなく、表現の強さと日常的な安全性を異なる方向から支える補完的な技法である。
